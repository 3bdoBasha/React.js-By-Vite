...
export default function App() {
  ...
  const [posts, setPosts] = useState([
    ...
    { id: 3, head: "🛠️الحل لجميع مشاكل البرمجة فهم أساسيات اللغة أولا ثم إختيار المسار الذي تريد", views: "100 Views", content: `Writed By Web Desinger`, likes: 0 , Writer: true},
  ]);
